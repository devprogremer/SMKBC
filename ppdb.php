...
<head>
  ...
  <title>Formulir PPDB - SMK BCC</title>
...
<section id="get-a-quote" class="get-a-quote">
      <div class="container  pt-12" data-aos="fade-up">
        ...
        <div class="row g-8">
          ...
          <div class="col-lg-7">
            <form action="forms/quote.php" method="post" class="php-email-form">
              <h3>Silahkan Isi Formulir Dengan Lengkap :</h3>
               <div class="row gy-4">

                <div class="col-md-6">
                    <h4> Nama Lengkap</h4>
                  <input type="text" name="departure" class="form-control" placeholder="City of Departure" required>
                  <p> Isi Dengan Benar Sesuai Akte !! </p>
                </div>

                <div class="col-md-6">
                <h6> No. HP atau WA Calon Siswa </h6>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Terima Kasih Telah Mengisi Formulir Dengan Baik !!</div>
